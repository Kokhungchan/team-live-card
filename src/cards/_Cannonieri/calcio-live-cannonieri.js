              ...
              <div class="card-header">
                <div class="header-row">
                  ...
                  <div class="competition-details">
                    <div class="competition-name">Top Scorers</div>
                    <div class="season-dates">Season: ${this.formatDate(season.startDate)} - ${this.formatDate(season.endDate)}</div>
                  </div>
                </div>
                <hr class="separator" />
              </div>
          ...
          ${scorers.slice(0, maxTotal).map((scorer, index) => html`
            <div class="scorer ${index % 2 === 0 ? 'even' : 'odd'}">
              ...
              <div class="info">
                ...
                <div class="played-matches">Matches played: <span class="matches-number">${scorer.playedMatches}</span></div>
              </div>
            </div>
          `)}
        </div>
...
customElements.define("team-live-scorers", CalcioLiveCannonieriCard);
